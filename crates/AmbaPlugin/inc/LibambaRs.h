...
extern "C" {
	...
	void rust_on_state_fork(u32 old_state_id, u32 *new_state_ids_ptr, usize new_state_ids_count);
	...
	void rust_on_watched_block_start_execute(u64 block_virtual_addr);
}
