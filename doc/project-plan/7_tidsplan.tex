...
\begin{ganttchart}[
    ...
    \ganttfoobar{Projektplan}{1}{4} \\

    % Eget
    \ganttfoobar{*S2E bygge}{2}{3} \\
    \ganttfoobar{*S2E bindings/infrastruktur}{3}{5} \\
    \ganttfoobar{*Fler analyskomponenter?}{5}{10} \\
    \ganttfoobar{*Brainstorming demos}{5}{10} \\
    \ganttfoobar{*Implementing demos}{5}{12} \\
    \ganttfoobar{*GUI-ramverk}{6}{9} \\ \\
    \ganttfoobar{*Slutprodukt}{8}{13} \\

    \ganttfoobar{Halvtidsredovisning}{6}{8} \\

    % TODO include deadlines for drafts of report for feedback meetings with fackspråk.
    \ganttfoobar{Film}{16}{17} \\
    \ganttfoobar{Skriftlig individuell opposition}{18}{18} \\
    \ganttfoobar{Slutrapport, förgranskning}{14}{14} \\
    \ganttfoobar{Slutrapport}{16}{16} \\
    \ganttfoobar{Slutgiltig rapport}{19}{19} \\

    \ganttfoobar{Slutredovisning}{18}{18} \\
