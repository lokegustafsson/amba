...
\begin{enumerate}
  ...
  \item dekompilera assemblykoden med ett verktyg som ger högnivåpseudokod, och sedan läsa denna mer
    läsbara koden.
...
avsaknanden av felaktiga slutsatser och \textit{abstrakt} på möjligheten att
