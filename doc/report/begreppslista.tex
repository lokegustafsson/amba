\begin{labeling}{begreppslista}
  ...
  \item[\textbf{Basic block}] En mängd på varandra följande rader kod
      utan hopp eller branches förutom till början och från slutet av
      blocket. Är oftast expanderade till att bli så långa som
      möjligt.
