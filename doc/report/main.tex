...
% START: Copied from https://tex.stackexchange.com/a/48012
\titleformat{\chapter}[display]
  {\normalfont\huge\bfseries}{}{0pt}{\Huge}
\titleformat{name=\chapter,numberless}[display]
  {\normalfont\huge\bfseries}{}{0pt}{\Huge}
\titlespacing*{\chapter}{0pt}{0pt}{*2}
% END: Copied from https://tex.stackexchange.com/a/48012
...
\chapter{Bakgrund}
\input{bakgrund/main.tex}
\section{Symbolisk Exekvering}
\input{bakgrund/symbolisk_exekvering.tex}
\section{Statisk och dynamisk binäranalys}
\input{bakgrund/statisk_dynamisk_binaranalys.tex}
\section{Existerande verktyg}
\input{bakgrund/existerande_verktyg.tex}

\chapter{Binäranalys}
\input{binaranalys/main.tex}
\section{Problem}
\input{binaranalys/problem.tex}
\section{Metod}
\input{binaranalys/metod.tex}
...
\input{diskussion/begransningar.tex}
