...
\newcommand{\ambaTitleNewLine}{AMBA:\@ Interaktiv visualisering av \\ symbolisk fuzzing}
...
% align next page on odd page as this is the second page and would fall on even
% page, DON'T REMOVE, \cleardoublepage doesn't put on new odd page unless
% `twoside` option is set. `twoside` option is set after this to avoid
% different margins in cover pages.
\newpage{\null{}}\newpage{}
...
\chapter*{Sammandrag}
\addcontentsline{toc}{chapter}{Sammandrag}
...
\phantomsection
\listoffigures
\addcontentsline{toc}{chapter}{Figurförteckning}
\cleardoublepage

\chapter*{Begreppslista}
\addcontentsline{toc}{chapter}{Begreppslista}
...
\section{Jämförelse mellan \stoe{} och angr som \\ exekveringsmotor}\label{sec:amba-vs-ghidra}
