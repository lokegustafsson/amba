Fuzzing är ett användbart automatiskt verktyg för att testa program i syfte att finna
...
som nyttjar symbolisk exekvering för att maximera code coverage --- dvs. fuzzerns
...
Som beskrivet i avsnittet \nameref{sec:symbolic_execution} sker detta genom att
