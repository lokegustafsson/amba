...
program men inte komplexa program. Variablerna x och y sätts till symboliska
värden som sedan används för att beräkna path constraint (jfr sv. vägvillkoret) och de symboliska
...
lösas med hjälp av en SMT-solver och därmed få ut ett konkret värde.
