...
\end{lstlisting}
    \caption{Pseudokod för att visualisera symbolisk exekvering.}\label{symbex_example_code}
\end{figure}
...
Figur~\ref{symbex_example_graph} visar hur det symboliska tillståndet förändras
för alla möjliga branches i programmet.
...
\begin{figure}[H]
    ...
    \caption{Path constraint och symboliskt tillstånd för alla vägar i
        pseudokoden angett i~\ref{symbex_example_code}.}\label{symbex_example_graph}
\end{figure}
