...
omgivning. För program är denna omgivning en virtuell värld bestående av filer,
...
undantag och kombinationer av dessa som kan orsaka ett exponentiellt stigande
