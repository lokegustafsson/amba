Detta arbete presenterar Amba, ett binäranalysverktyg för att visualisera och
styra symbolisk fuzzing interaktivt. I detta avsnitt kommer vi att beskriva
funktionalitet i Amba, Ambas begräsningar samt hur man kan köra och använda
Amba.
