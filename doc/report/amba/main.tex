...
grafer som kan exempelvis skapas av program som inte terminerar eller vid
vägexplosionsproblemet. En nod i tillståndsgrafen kan prioriteras genom dubbelklick på
motsvarande nod.
...
till stor del en fundamental begränsning i symbolisk fuzzing och
kräver andra metoder för att angripa problemet på ett bättre sätt.
