...
\end{lstlisting}
    \caption{Metadata för en nod bestående av symboliskt tillstånd och
    tillhörande virtuell adress.}\label{fig:nodemetadata}
\end{figure}
...
exekvering. Graferna består av ett antal noder med metadata, se
fig~\ref{fig:nodemetadata} sammankopplade
